...
// Machine defines as used in ELF headers
// http://www.sco.com/developers/gabi/latest/ch4.eheader.html

// These values are used in the device identification
// As there are standardised values for (almost) any CPU and MCU architecture
// We are using the values as defined by the ELF standard
...
/* ff later verder gaan met de comments
...
#define reserved 	121-130 	Reserved for future use
...
#define reserved 	145-159 	Reserved for future use
...
// Defines for MCU Manufacturers, using their USB Vendor ID to identify
#define VE_ATMEL 		0x03eb
#define VE_STM   		0x0483
#define VE_NORDICSEMI	0x1915
#define VE_MICROCHIP 	0x04d8
